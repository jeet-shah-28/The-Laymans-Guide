...
<div class="bottom">
    ...
    <div class="first">
        <div class="left">
            <p>
                Logistics refer to efficient management, storage and transport of resources.
                Having a knowledge in logistics makes a person a better investor/supplier in business terms or in general helps
                saving money and keeping record of their purchases, bills or savings.
            </p>
        </div>
        <div class="right" style="background-image: url('img/logi1.gif'); background-size: 96% 100%">
            <!-- <img src="img/ewallet_intro.jpg"> -->
        </div>
    </div>

    <h2>Why does one need this knowledge?</h2>
    <div class="first">
        <div class="right" style="background-image: url('img/logi2.gif'); background-size: 90% 100%">
        </div>
        <div class="left">
            <p>
                As discussed above, logistics refers to management of resources.
                In day to day life, keeping track of purchases and bills helps in keeping track of use of money.
                Similarly, it will also help with savings because one has the data of their needs and requirements
                per month ready if they follow logistical approach.
                In all logistics will help in keeping track of the flow of money in their day to day life.
            </p>
            <!-- <img src="img/ewallet3.jpg"> -->
        </div>
    </div>
    <h2>Implementing logistics : </h2>
    <div class="first">
        <div class="left">
            <p>
                One of the main concepts of logistics is resource management.
                This can be done via keeping an initial value/allotting an initial value of a resource to yourself which is not too big nor too small
                and the keeping a track of how the resource is used and how much quantity of the resource is used per time of use.
                This will give the person a graph which can be used to keep track on how much is used on average and how much will be needed in future,
                hence the user does not take excess or lack of that resource.
            </p>
        </div>
        <div class="right" style="background-image: url('img/logi3.gif');">
            <!-- <img src="img/ewallet3.jpg"> -->
        </div>
    </div>
</div>
